...
!function() {
    ...
    function V(c, h) {
        var a = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks
          , l = void 0 !== a && a
          , z = Object.keys(h).reduce(function(c, a) {
            var l = h[a];
            return !!l.icon ? c[l.iconName] = l.icon : c[a] = l,
            c
        }, {});
        "function" != typeof s.hooks.addPack || l ? s.styles[c] = function(z) {
            for (var c = 1; c < arguments.length; c++) {
                var v = null != arguments[c] ? arguments[c] : {}
                  , a = Object.keys(v);
                "function" == typeof Object.getOwnPropertySymbols && (a = a.concat(Object.getOwnPropertySymbols(v).filter(function(c) {
            ...
            return z
        }({}, s.styles[c] || {}, z) : s.hooks.addPack(c, z),
        "fas" === c && V("fa", h)
    }
    var L = {
...
function() {
    ...
    function e(c, a) {
        return function(c) {
            ...
            var l = []
              ...
              , v = void 0;
            try {
                for (var m, M = c[Symbol.iterator](); !(h = (m = M.next()).done) && (l.push(m.value),
                !a || l.length !== a); h = !0)
                    ;
            } catch (c) {
                z = !0,
    ...
    function f(c) {
        return function(c) {
            if (Array.isArray(c)) {
                for (var a = 0, l = new Array(c.length); a < c.length; a++)
                    l[a] = c[a];
                return l
            }
        }(c) || function(c) {
    ...
    var M = (a.navigator || {}).userAgent
      ...
      , V = m
      , L = !!r.document
      , C = !!o.documentElement && !!o.head && "function" == typeof o.addEventListener && "function" == typeof o.createElement
      , u = ~H.indexOf("MSIE") || ~H.indexOf("Trident/")
      ...
      , x = "fa-layers-text"
      , j = /Font Awesome 5 (Solid|Regular|Light|Duotone|Brands|Free|Pro)/
      , O = {
        900: "fas",
        400: "far",
        normal: "far",
      ...
      , T = ["xs", "sm", "lg", "fw", "ul", "li", "border", "pull-left", "pull-right", "spin", "pulse", "rotate-90", "rotate-180", "rotate-270", "flip-horizontal", "flip-vertical", "flip-both", "stack", "stack-1x", "stack-2x", "inverse", "layers", "layers-text", "layers-counter", N.GROUP, N.SWAP_OPACITY, N.PRIMARY, N.SECONDARY].concat(P.map(function(c) {
        return "".concat(c, "x")
    })).concat(E.map(function(c) {
        return "w-".concat(c)
    }))
      , R = r.FontAwesomeConfig || {};
    if (o && "function" == typeof o.querySelector) {
        [["data-family-prefix", "familyPrefix"], ["data-replacement-class", "replacementClass"], ["data-auto-replace-svg", "autoReplaceSvg"], ["data-auto-add-css", "autoAddCss"], ["data-auto-a11y", "autoA11y"], ["data-search-pseudo-elements", "searchPseudoElements"], ["data-observe-mutations", "observeMutations"], ["data-mutate-approach", "mutateApproach"], ["data-keep-original-source", "keepOriginalSource"], ["data-measure-performance", "measurePerformance"], ["data-show-missing-icons", "showMissingIcons"]].forEach(function(c) {
            var a, l = e(c, 2), h = l[0], z = l[1], v = "" === (a = function(c) {
                var a = o.querySelector("script[" + c + "]");
                if (a)
    ...
    var K = X({}, F);
    r.FontAwesomeConfig = K;
    var I = r || {};
    I[t] || (I[t] = {}),
    I[t].styles || (I[t].styles = {}),
    I[t].hooks || (I[t].hooks = {}),
    I[t].shims || (I[t].shims = []);
    var D = I[t]
      , Y = []
      , W = !1;
    function Q(c) {
        C && (W ? setTimeout(c, 0) : Y.push(c))
    }
    C && ((W = (o.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(o.readyState)) || o.addEventListener("DOMContentLoaded", function c() {
        o.removeEventListener("DOMContentLoaded", c),
        W = 1,
        Y.map(function(c) {
            return c()
        })
    }));
    var U, G = "pending", J = "settled", $ = "fulfilled", cc = "rejected", ac = function() {}, lc = "undefined" != typeof global && void 0 !== global.process && "function" == typeof global.process.emit, hc = "undefined" == typeof setImmediate ? setTimeout : setImmediate, zc = [];
    function vc() {
    ...
    function Hc(a, l) {
        ...
        try {
            ...
            if (l && ("function" == typeof l || "object" === v(l))) {
                var c = l.then;
                if ("function" == typeof c)
                    return c.call(l, function(c) {
                        h || (h = !0,
                        l === c ? Vc(a, c) : sc(a, c))
                    }, function(c) {
                        h || (h = !0,
    ...
    function Cc(c) {
        c._state = cc,
        ec(c),
        !c._handled && lc && global.process.emit("unhandledRejection", c._data, c)
    }
    function tc(c) {
    ...
    rc.prototype = {
        ...
        then: function(c, a) {
            var l = {
                owner: this,
                then: new this.constructor(ac),
                fulfilled: c,
                rejected: a
            };
            return !a && !c || this._handled || (this._handled = !0,
            this._state === cc && lc && mc(tc, this)),
            this._state === $ || this._state === cc ? mc(Mc, l) : this._then.push(l),
            l.then
        },
        catch: function(c) {
    ...
    rc.all = function(M) {
        ...
        return new rc(function(l, c) {
            ...
            for (var v, m = 0; m < M.length; m++)
                (v = M[m]) && "function" == typeof v.then ? v.then(a(m), c) : h[m] = v;
            z || l(h)
        }
        )
    }
    ...
    rc.race = function(z) {
        ...
        return new rc(function(c, a) {
            for (var l, h = 0; h < z.length; h++)
                (l = z[h]) && "function" == typeof l.then ? l.then(c, a) : c(l)
        }
        )
    }
    ,
    rc.resolve = function(a) {
        return a && "object" === v(a) && a.constructor === rc ? a : new rc(function(c) {
            c(a)
        }
        )
    }
    ,
    rc.reject = function(l) {
        return new rc(function(c, a) {
            a(l)
        }
        )
    ...
    ;
    var oc = "function" == typeof Promise ? Promise : rc
      , ic = b
      , nc = {
        size: 16,
        x: 0,
    ...
    function Ac(c) {
        if (c && C) {
            ...
            a.innerHTML = c;
            for (var l = o.head.childNodes, h = null, z = l.length - 1; -1 < z; z--) {
                var v = l[z]
                  , m = (v.tagName || "").toUpperCase();
                -1 < ["STYLE", "LINK"].indexOf(m) && (h = v)
            }
            return o.head.insertBefore(a, h),
            c
        }
    }
    ...
    function uc() {
        for (var c = 12, a = ""; 0 < c--; )
            a += dc[62 * Math.random() | 0];
        return a
    }
    function bc(c) {
        for (var a = [], l = (c || []).length >>> 0; l--; )
            a[l] = c[l];
        return a
    }
    function pc(c) {
    ...
    function gc(c, a) {
        var l, h = a.split("-"), z = h[0], v = h.slice(1).join("-");
        return z !== c || "" === v || (l = v,
        ~T.indexOf(l)) ? null : v
    }
    function Sc(c) {
    ...
    function wc(l) {
        return Object.keys(l || {}).reduce(function(c, a) {
            return c + "".concat(a, ": ").concat(l[a], ";")
        }, "")
    }
    function kc(c) {
        return c.size !== nc.size || c.x !== nc.x || c.y !== nc.y || c.rotate !== nc.rotate || c.flipX || c.flipY
    }
    function yc(c) {
        var a = c.transform
          , l = c.containerWidth
          ...
          , v = "translate(".concat(32 * a.x, ", ").concat(32 * a.y, ") ")
          , m = "scale(".concat(a.size / 16 * (a.flipX ? -1 : 1), ", ").concat(a.size / 16 * (a.flipY ? -1 : 1), ") ")
          , M = "rotate(".concat(a.rotate, " 0 0)");
        return {
            outer: z,
            inner: {
                transform: "".concat(v, " ").concat(m, " ").concat(M)
            },
            path: {
    ...
    function qc(c) {
        ...
        return c.attributes && (c.attributes.fill || a) && (c.attributes.fill = "black"),
        c
    }
    function xc(c) {
        var a = c.icons
          ...
          , f = e.width
          , C = e.height
          , t = "fa-w-".concat(Math.ceil(f / C * 16))
          , r = [K.replacementClass, v ? "".concat(K.familyPrefix, "-").concat(v) : "", t].filter(function(c) {
            return -1 === s.classes.indexOf(c)
        }).concat(s.classes).join(" ")
          , o = {
            children: [],
            attributes: X({}, s.attributes, {
                "data-prefix": z,
                "data-icon": v,
                class: r,
        ...
        H && o.children.push({
            tag: "title",
            attributes: {
                id: o.attributes["aria-labelledby"] || "title-".concat(uc())
            },
            children: [H]
        });
        var i, n, A, d, u, b, p, g, S, w, k, y, Z, q, x, j, O, P, E, _, N, T, R, F, I, D, Y = X({}, o, {
            prefix: z,
            iconName: v,
            main: l,
            mask: h,
            ...
            symbol: M,
            styles: s.styles
        }), W = h.found && l.found ? (A = (i = Y).children,
        d = i.attributes,
        u = i.main,
        b = i.mask,
        p = i.transform,
        ...
        q = S.children ? {
            children: S.children.map(qc)
        } : {},
        x = {
            tag: "g",
            attributes: X({}, y.inner),
            children: [qc(X({
                tag: S.tag,
                attributes: X({}, S.attributes, y.path)
            }, q))]
        },
        j = {
            tag: "g",
            attributes: X({}, y.outer),
            children: [x]
        },
        O = "mask-".concat(uc()),
        P = "clip-".concat(uc()),
            ...
            kc(z)) {
                ...
                a.push({
                    ...
                    children: [{
                        ...
                        children: [{
                            tag: h.icon.tag,
                            children: h.icon.children,
                            attributes: X({}, h.icon.attributes, m.path)
                        }]
                    }]
                })
            } else
        ...
        [{
            ...
            children: [{
                tag: "symbol",
                attributes: X({}, I, {
                    id: !0 === D ? "".concat(T, "-").concat(K.familyPrefix, "-").concat(R) : D
                }),
                children: F
            }]
        }]) : function(c) {
            var a = c.children
              ...
              , v = c.styles
              , m = c.transform;
            if (kc(m) && l.found && !h.found) {
                var M = l.width / l.height / 2
                  , H = .5;
                z.style = wc(X({}, v, {
                    "transform-origin": "".concat(M + m.x / 16, "em ").concat(H + m.y / 16, "em")
                }))
            }
            return [{
                tag: "svg",
    ...
    function jc(c) {
        ...
        H && (s[B] = "");
        var V, L, e, f, C, t, r, o, i, n = X({}, m.styles);
        kc(z) && (n.transform = (L = (V = {
            transform: z,
            startCentered: !0,
            width: l,
            height: h
        ...
        r = V.startCentered,
        i = "",
        i += (o = void 0 !== r && r) && u ? "translate(".concat(L.x / ic - f / 2, "em, ").concat(L.y / ic - t / 2, "em) ") : o ? "translate(calc(-50% + ".concat(L.x / ic, "em), calc(-50% + ").concat(L.y / ic, "em)) ") : "translate(".concat(L.x / ic, "em, ").concat(L.y / ic, "em) "),
        i += "scale(".concat(L.size / ic * (L.flipX ? -1 : 1), ", ").concat(L.size / ic * (L.flipY ? -1 : 1), ") "),
        i += "rotate(".concat(L.rotate, "deg) ")),
        n["-webkit-transform"] = n.transform);
        var A = wc(n);
        0 < A.length && (s.style = A);
        var d = [];
        return d.push({
            tag: "span",
            attributes: s,
    ...
    var Oc = function() {}
      , Pc = K.measurePerformance && V && V.mark && V.measure ? V : {
        mark: Oc,
        measure: Oc
    }
      , Ec = 'FA "5.11.1"'
      ...
      , Tc = function(c, a, l, h) {
        var z, v, m, M, H, s = Object.keys(c), V = s.length, L = void 0 !== h ? (M = a,
        H = h,
        function(c, a, l, h) {
            return M.call(H, c, a, l, h)
        }
        ) : a;
        for (m = void 0 === l ? (z = 1,
        c[s[0]]) : (z = 0,
    ...
    function Rc(c) {
        for (var a = "", l = 0; l < c.length; l++) {
            a += ("000" + c.charCodeAt(l).toString(16)).slice(-4)
        }
        return a
    }
    var Fc = D.styles
      ...
      , Qc = function() {
        ...
        var v = "far"in Fc;
        Wc = Tc(Ic, function(c, a) {
            var l = a[0]
              , h = a[1]
              , z = a[2];
            return "far" !== h || v || (h = "fas"),
            c[l] = {
                prefix: h,
                iconName: z
            },
    ...
    function Kc(c) {
        return c.reduce(function(c, a) {
            var l = gc(K.familyPrefix, a);
            if (Xc[a])
                c.prefix = a;
            else if (K.autoFetchSvg && -1 < ["fas", "far", "fal", "fad", "fab", "fa"].indexOf(a))
                c.prefix = a;
            else if (l) {
                var h = "fa" === c.prefix ? Wc[l] || {
                    prefix: null,
                    iconName: null
                } : {};
                c.iconName = h.iconName || l,
                c.prefix = h.prefix || c.prefix
            } else
                a !== K.replacementClass && 0 !== a.indexOf("fa-w-") && c.rest.push(a);
            return c
        }, Bc())
    }
    function Gc(c, a, l) {
    ...
    function Jc(c) {
        var l, a = c.tag, h = c.attributes, z = void 0 === h ? {} : h, v = c.children, m = void 0 === v ? [] : v;
        return "string" == typeof c ? Sc(c) : "<".concat(a, " ").concat((l = z,
        Object.keys(l || {}).reduce(function(c, a) {
            return c + "".concat(a, '="').concat(Sc(l[a]), '" ')
        }, "").trim()), ">").concat(m.map(Jc).join(""), "</").concat(a, ">")
    }
    var $c = function() {};
    function ca(c) {
    ...
    var aa = {
        replace: function(c) {
            var a = c[0]
              , l = c[1].map(function(c) {
                return Jc(c)
            }).join("\n");
            if (a.parentNode && a.outerHTML)
                a.outerHTML = l + (K.keepOriginalSource && "svg" !== a.tagName.toLowerCase() ? "\x3c!-- ".concat(a.outerHTML, " --\x3e") : "");
        ...
        nest: function(c) {
            var a = c[0]
              , l = c[1];
            if (~pc(a).indexOf(K.replacementClass))
                return aa.replace(c);
            var h = new RegExp("".concat(K.familyPrefix, "-.*"));
            delete l[0].attributes.style,
            delete l[0].attributes.id;
            var z = l[0].attributes.class.split(" ").reduce(function(c, a) {
                return a === K.replacementClass || a.match(h) ? c.toSvg.push(a) : c.toNode.push(a),
                c
            }, {
                toNode: [],
                toSvg: []
            });
            l[0].attributes.class = z.toSvg.join(" ");
            var v = l.map(function(c) {
                return Jc(c)
            }).join("\n");
            a.setAttribute("class", z.toNode.join(" ")),
            a.setAttribute(B, ""),
            a.innerHTML = v
        }
    };
    ...
    function ha(l, c) {
        var h = "function" == typeof c ? c : $c;
        if (0 === l.length)
            h();
        else {
            var a = la;
            K.mutateApproach === w && (a = r.requestAnimationFrame || la),
            a(function() {
                var c = !0 === K.autoReplaceSvg ? aa.replace : aa[K.autoReplaceSvg] || aa.replace
                  , a = Nc.begin("mutate");
                l.map(c),
                a(),
                h()
    ...
    var ma = null;
    function Ma(c) {
        if (s && K.observeMutations) {
            var z = c.treeCallback
              , v = c.nodeCallback
              , m = c.pseudoElementsCallback
              , a = c.observeMutationsRoot
              , l = void 0 === a ? o : a;
            ma = new s(function(c) {
                za || bc(c).forEach(function(c) {
                    if ("childList" === c.type && 0 < c.addedNodes.length && !ca(c.addedNodes[0]) && (K.searchPseudoElements && m(c.target),
                    z(c.target)),
                    "attributes" === c.type && c.target.parentNode && K.searchPseudoElements && m(c.target.parentNode),
                    "attributes" === c.type && ca(c.target) && ~_.indexOf(c.attributeName))
                        if ("class" === c.attributeName) {
                            var a = Kc(pc(c.target))
                              , l = a.prefix
                              , h = a.iconName;
                            l && c.target.setAttribute("data-prefix", l),
                            h && c.target.setAttribute("data-icon", h)
                        } else
                            v(c.target)
                })
            }
    ...
    function Ha(c) {
        var a, l, h = c.getAttribute("data-prefix"), z = c.getAttribute("data-icon"), v = void 0 !== c.innerText ? c.innerText.trim() : "", m = Kc(pc(c));
        return h && z && (m.prefix = h,
        m.iconName = z),
        m.prefix && 1 < v.length ? m.iconName = (a = m.prefix,
        l = c.innerText,
        (Yc[a] || {})[l]) : m.prefix && 1 === v.length && (m.iconName = Uc(m.prefix, Rc(c.innerText))),
        m
    }
    var sa = function(c) {
        var a = {
        ...
        return c ? c.toLowerCase().split(" ").reduce(function(c, a) {
    ...
    function Va(c) {
        var a, l, h, z, v, m, M, H = Ha(c), s = H.iconName, V = H.prefix, L = H.rest, e = (a = c.getAttribute("style"),
        l = [],
        a && (l = a.split(";").reduce(function(c, a) {
            var l = a.split(":")
              , h = l[0]
              , z = l.slice(1);
            return h && 0 < z.length && (c[h] = z.join(":").trim()),
            c
        }, {})),
        l), f = sa(c.getAttribute("data-fa-transform")), C = null !== (h = c.getAttribute("data-fa-symbol")) && ("" === h || h), t = (v = bc((z = c).attributes).reduce(function(c, a) {
            return "class" !== c.name && "style" !== c.name && (c[a.name] = a.value),
            c
        }, {}),
        m = z.getAttribute("title"),
        K.autoA11y && (m ? v["aria-labelledby"] = "".concat(K.replacementClass, "-title-").concat(uc()) : (v["aria-hidden"] = "true",
        v.focusable = "false")),
        v), r = (M = c.getAttribute("data-fa-mask")) ? Kc(M.split(" ").map(function(c) {
            return c.trim()
        })) : Bc();
        return {
            iconName: s,
    ...
    (La.prototype = Object.create(Error.prototype)).constructor = La;
    var ea = {
        fill: "currentColor"
    }
      , fa = {
    ...
    function ia(c) {
        ...
        return {
            ...
            width: a,
            height: l,
            icon: Array.isArray(h) ? {
                tag: "g",
                attributes: {
                    class: "".concat(K.familyPrefix, "-").concat(N.GROUP)
                },
                children: [{
                    tag: "path",
                    attributes: {
                        class: "".concat(K.familyPrefix, "-").concat(N.SECONDARY),
                        fill: "currentColor",
                        d: h[0]
                    }
                }, {
                    tag: "path",
                    attributes: {
                        class: "".concat(K.familyPrefix, "-").concat(N.PRIMARY),
                        fill: "currentColor",
                        d: h[1]
                    }
                }]
    ...
    function na(h, z) {
        return new oc(function(c, a) {
            ...
            if (h && z && oa[z] && oa[z][h])
                return c(ia(oa[z][h]));
            "object" === v(r.FontAwesomeKitConfig) && "string" == typeof window.FontAwesomeKitConfig.token && r.FontAwesomeKitConfig.token,
            h && z && !K.showMissingIcons ? a(new La("Icon is missing for prefix ".concat(z, " with icon name ").concat(h))) : c(l)
        }
        )
    }
    var Aa = D.styles;
    function da(c) {
        var v, a, m, M, H, s, V, l, L, h = Va(c);
        return ~h.extra.classes.indexOf(x) ? function(c, a) {
            ...
            return K.autoA11y && !l && (z.attributes["aria-hidden"] = "true"),
            oc.resolve([c, jc({
                content: c.innerHTML,
                width: v,
                height: m,
        ...
        L = a.extra,
        new oc(function(z, c) {
            oc.all([na(m, H), na(l.iconName, l.prefix)]).then(function(c) {
                var a = e(c, 2)
                  , l = a[0]
                  , h = a[1];
                z([v, xc({
    ...
    function ua(c) {
        ...
        if (C) {
            var a = o.documentElement.classList
              , h = function(c) {
                return a.add("".concat(S, "-").concat(c))
            }
              , z = function(c) {
                return a.remove("".concat(S, "-").concat(c))
            }
              , v = K.autoFetchSvg ? Object.keys(Z) : Object.keys(Aa)
              , m = [".".concat(x, ":not([").concat(B, "])")].concat(v.map(function(c) {
                return ".".concat(c, ":not([").concat(B, "])")
            })).join(", ");
            if (0 !== m.length) {
                var M = [];
                try {
                    M = bc(c.querySelectorAll(m))
                } catch (c) {}
                if (0 < M.length) {
                    h("pending"),
                    z("complete");
                    var H = Nc.begin("onTree")
                      , s = M.reduce(function(c, a) {
                        try {
                            var l = da(a);
                            l && c.push(l)
                        } catch (c) {
                            y || c instanceof La && console.error(c)
                        }
                        return c
                    }, []);
                    return new oc(function(a, c) {
                        oc.all(s).then(function(c) {
                            ha(c, function() {
                                h("active"),
                                h("complete"),
                                z("pending"),
    ...
    function ba(c) {
        ...
        da(c).then(function(c) {
            c && ha([c], a)
        })
    }
    function pa(f, C) {
        var t = "".concat(d).concat(C.replace(":", "-"));
        return new oc(function(h, c) {
            if (null !== f.getAttribute(t))
                return h();
            var a = bc(f.children).filter(function(c) {
                return c.getAttribute(A) === C
            })[0]
              , l = r.getComputedStyle(f, C)
              , z = l.getPropertyValue("font-family").match(j)
              , v = l.getPropertyValue("font-weight");
            if (a && !z)
                return f.removeChild(a),
                h();
            if (z) {
                var m = l.getPropertyValue("content")
                  , M = ~["Solid", "Regular", "Light", "Duotone", "Brands"].indexOf(z[1]) ? q[z[1].toLowerCase()] : O[v]
                  , H = Rc(3 === m.length ? m.substr(1, 1) : m)
                  , s = Uc(M, H)
                  , V = s;
                if (!s || a && a.getAttribute(p) === M && a.getAttribute(g) === V)
                    h();
                else {
                    f.setAttribute(t, V),
                    a && f.removeChild(a);
                    ...
                    na(s, M).then(function(c) {
                        ...
                        ":before" === C ? f.insertBefore(l, f.firstChild) : f.appendChild(l),
                        l.outerHTML = a.map(function(c) {
                            return Jc(c)
                        }).join("\n"),
                        f.removeAttribute(t),
                        h()
    ...
    function ga(c) {
        return oc.all([pa(c, ":before"), pa(c, ":after")])
    }
    function Sa(c) {
        return !(c.parentNode === document.head || ~k.indexOf(c.tagName.toUpperCase()) || c.getAttribute(A) || c.parentNode && "svg" === c.parentNode.tagName)
    }
    function wa(z) {
        if (C)
            return new oc(function(c, a) {
                var l = bc(z.querySelectorAll("*")).filter(Sa).map(ga)
                  , h = Nc.begin("searchPseudoElements");
                za = !0,
                oc.all(l).then(function() {
                    h(),
                    va(),
                    c()
                }).catch(function() {
    ...
    function qa(a, c) {
        ...
        Object.defineProperty(a, "html", {
            get: function() {
                return a.abstract.map(function(c) {
                    return Jc(c)
                })
            }
        }),
    ...
    function xa(c) {
        var a = c.prefix
          ...
          , h = c.iconName;
        if (h)
            return Gc(Oa.definitions, l, h) || Gc(D.styles, l, h)
    }
    var ja, Oa = new (function() {
        ...
        (l = [{
            key: "add",
            value: function() {
                for (var a = this, c = arguments.length, l = new Array(c), h = 0; h < c; h++)
                    l[h] = arguments[h];
                var z = l.reduce(this._pullDefinitions, {});
                Object.keys(z).forEach(function(c) {
                    a.definitions[c] = X({}, a.definitions[c] || {}, z[c]),
                    function c(a, h) {
                        var l = (2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}).skipHooks
                          , z = void 0 !== l && l
                          , v = Object.keys(h).reduce(function(c, a) {
                            var l = h[a];
                            return l.icon ? c[l.iconName] = l.icon : c[a] = l,
                            c
                        }, {});
                        "function" != typeof D.hooks.addPack || z ? D.styles[a] = X({}, D.styles[a] || {}, v) : D.hooks.addPack(a, v),
                        "fas" === a && c("fa", h)
                    }(c, z[c]),
                    Qc()
                })
        ...
        i2svg: function() {
            ...
            if (C) {
                ...
                var a = c.node
                  ...
                  , z = void 0 === h ? function() {}
                : h;
                return K.searchPseudoElements && wa(l),
                ua(l, z)
            }
        ...
        if (c) {
            ...
            return qa(X({
                ...
                return Za(),
                K.autoA11y && (s ? f["aria-labelledby"] = "".concat(K.replacementClass, "-title-").concat(uc()) : (f["aria-hidden"] = "true",
                f.focusable = "false")),
                xc({
                    icons: {
                        main: ia(i),
    ...
    function(c) {
            ...
            return qa({
                ...
                jc({
                    ...
                    extra: {
                        attributes: s,
                        styles: L,
                        classes: ["".concat(K.familyPrefix, "-layers-text")].concat(f(M))
                    }
                })
            })
        },
            ...
            return qa({
                ...
                function(c) {
                    ...
                    extra: {
                        attributes: M,
                        styles: s,
                        classes: ["".concat(K.familyPrefix, "-layers-counter")].concat(f(v))
                    }
                })
            })
        },
        layer: function(c) {
            var a = (1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}).classes
              , l = void 0 === a ? [] : a;
            return qa({
                type: "layer"
            }, function() {
                ...
                [{
                    tag: "span",
                    attributes: {
                        class: ["".concat(K.familyPrefix, "-layers")].concat(f(l)).join(" ")
                    },
                    children: a
                }]
            })
        ...
        var c = (0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).autoReplaceSvgRoot
          , a = void 0 === c ? o : c;
        (0 < Object.keys(D.styles).length || K.autoFetchSvg) && C && K.autoReplaceSvg && Na.dom.i2svg({
            node: a
        })
    };
    !function(c) {
        ...
        L && (r.FontAwesome || (r.FontAwesome = Na),
        Q(function() {
            Ta(),
            Ma({
                treeCallback: ua,
        ...
        D.hooks = X({}, D.hooks, {
            addPack: function(c, a) {
                D.styles[c] = X({}, D.styles[c] || {}, a),
                Qc(),
                Ta()
            },
            addShims: function(c) {
                var a;
                (a = D.shims).push.apply(a, f(c)),
                Qc(),
                Ta()
            }
        })
